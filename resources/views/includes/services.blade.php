        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide flex justify-center">
                    <div
                        class="service card p-6 text-center bg-white rounded-lg shadow-md border-0 hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                        <div
                            class="icon bg-success text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto text-2xl mb-4">
