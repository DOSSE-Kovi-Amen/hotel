            ...
            <div class="modal-body p-4">
                ...
                <div class="row g-4">
                    ...
                    @if (!empty($images) && is_array($images))
                        <!-- Main Image -->
                        <div class="col-lg-8">
                            <div class="main-image-container rounded-3 overflow-hidden shadow-sm"
                                style="height: 400px;">
                                <img src="{{ asset(Voyager::image($mainImage)) }}" alt="{{ $room->title }}"
                                    class="w-100 h-100 object-fit-cover" id="mainRoomImage{{ $room->id }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                                    ...
                                    @foreach ($images as $key => $image)
                                        <div class="col-4 col-md-3 col-lg-6">
                                            <img src="{{ asset(Voyager::image($image)) }}"
                                                alt="Thumbnail {{ $key + 1 }}" class="img-thumbnail cursor-pointer"
                            ...
                            <div class="room-details">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="badge bg-success fs-6">{{ number_format($room->price, 0, ',', ' ') }}
                                        FCFA</span>
                                    @if ($room->is_featured)
                                ...
                                <div class="amenities mb-4">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <span class="badge bg-light text-dark border"><i class="fas fa-wifi me-1"></i>
                                            WiFi</span>
                                        <span class="badge bg-light text-dark border"><i class="fas fa-tv me-1"></i>
                                            TV</span>
                                        <span class="badge bg-light text-dark border"><i
                                                class="fas fa-snowflake me-1"></i> Climatisation</span>
                                        <span class="badge bg-light text-dark border"><i class="fas fa-shower me-1"></i>
                                            Douche</span>
                                    </div>
                                </div>
